        ...
        try {
            ...
            res.json({
                ...
                financeiro: {
                    ...
                    lulu_taxas_deposito_periodo: parseFloat(dados.lulu_taxas_deposito_periodo),
                    lulu_valor_deduzido_periodo: parseFloat(dados.lulu_valor_deduzido_periodo),
                    lulu_taxas_deposito_total:   parseFloat(dados.lulu_taxas_deposito_total),
                    lulu_valor_deduzido_total:   parseFloat(dados.lulu_valor_deduzido_total),
                },
