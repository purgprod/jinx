-- Adiciona os tipos novo_usuario e novo_objetivo ao ENUM de notificações.
...
-- 2. Adiciona novo_usuario e novo_objetivo ao ENUM
...
-- 3. Recria a coluna gerada (novo_usuario e novo_objetivo caem no ELSE → 'normal')
ALTER TABLE notificacoes
